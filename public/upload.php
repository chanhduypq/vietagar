...
if ($handle->uploaded) {
    ...
    if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') {
        $handle->process($_SERVER['DOCUMENT_ROOT'] . '/images/database/ckeditor/');
    } else {
        $handle->process($_SERVER['DOCUMENT_ROOT'] . '/public/images/database/ckeditor/');
    }    
    $image_url = '/images/database/ckeditor/' . $handle->file_dst_name;          // URL for the uploaded image
