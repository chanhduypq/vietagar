 ...
 */
class Core_Cache_Backend_File extends Zend_Cache_Backend_File
{
    ...
    public function __construct(array $options = array())
    {
        ...
        $this->_disabledTags = Core::single('core/cache')->getDisabled();
    }
    ...
    public function save($data, $id, $tags = array(), $specificLifetime = false)
    {
        ...
        if (!$specificLifetime && count($tags)) {
            $specificLifetime = Core::single('core/cache')->getLifetimeByTags($tags);
        }
