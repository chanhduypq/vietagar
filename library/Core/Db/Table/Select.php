...
class Core_Db_Table_Select extends Zend_Db_Table_Select
{
     ...
     *
     * @param bool $flag
     * @return Core_Db_Table_Select Fluent interface
     */
     ...
     * @return Core_Db_Table_Select This Core_Db_Table_Select object
     */
...
//        }
        ...
        $prefix = $this->_info[Core_Db_Table_Abstract::PREFIX];
        if (is_array($name)) {
...
//        }
     ...
     *  Debug function
     *
     * @return Core_Db_Table_Select Fluent
     */
    public function firephp()
    {
        if ('development' === Core::app()->getEnvironment()) {
            Core_FirePhp::log($this->__toString());
        }
        return $this;
    }
     ...
     * Example of usage:
     * <code>
     *  $result = Core::model('catalog/product')
