 ...
 * @version    $Id: GreaterThan.php 24594 2012-01-05 21:27:01Z matthew $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Core_Validate_GreaterThan extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::NOT_GREATER => "'%value%' đã nhỏ hơn '%min%'",
    );
