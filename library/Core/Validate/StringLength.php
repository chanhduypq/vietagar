...
class Core_Validate_StringLength extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::INVALID   => "Vui lòng nhập các kí tự.",
        self::TOO_SHORT => "'%value%' đã ít hơn %min% kí tự.",
        self::TOO_LONG  => "'%value%' đã nhiều hơn %max% kí tự.",
    );
     ...
     * @return Core_Validate_StringLength Provides a fluent interface
     */
     ...
     * @return Core_Validate_StringLength
     */
