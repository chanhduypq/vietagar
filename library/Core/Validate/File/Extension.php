...
class Core_Validate_File_Extension extends Zend_Validate_Abstract
{
    /**
    ...
    protected $_messageTemplates = array(
        self::FALSE_EXTENSION => "File '%value%' không đúng kiểu file cần lưu.",
        self::NOT_FOUND       => "File '%value%' không tồn tại hoặc không thể đọc.",
    );
     ...
     *
     * @param  boolean $case
     * @return Core_Validate_File_Extension Provides a fluent interface
     */
