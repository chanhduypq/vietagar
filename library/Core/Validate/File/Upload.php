 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class Core_Validate_File_Upload extends Zend_Validate_Abstract
{
    /**@#+
    ...
    protected $_messageTemplates = array(
        ...
        self::NO_FILE        => "File '%value%' chưa được chọn",
        ...
        self::FILE_NOT_FOUND => "File '%value%' không được tìm thấy",
