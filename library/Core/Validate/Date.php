 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Core_Validate_Date extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::INVALID        => "Giá trị này không phải là kiểu ngày.",
        self::INVALID_DATE   => "'%value%' không phải là ngày theo kiểu Ngày/Tháng/Năm.",
    	self::FALSEFORMAT    => "'%value%' không phải là ngày theo kiểu Ngày/Tháng/Năm.",    	
        //self::FALSEFORMAT    => "'%value%' không phải là ngày theo định dạng '%format%'",
    );
     ...
     * @return Core_Validate_Date provides a fluent interface
     */
