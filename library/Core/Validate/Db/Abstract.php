 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Core_Validate_Db_Abstract extends Zend_Validate_Abstract
{
    /**
     * Error constants
     */
    ...
    protected $_messageTemplates = array(
        self::ERROR_NO_RECORD_FOUND => "Không tồn tại thông tin  '%value%'",
        self::ERROR_RECORD_FOUND    => "Đã tồn tại thông tin '%value%'",
    );
