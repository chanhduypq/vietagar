 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Core_View_Helper_JQMFormRadio extends Zend_View_Helper_FormElement
{
    /**
     * Input type to use
     * @var string
     ...
     */
    public function jQMFormRadio($name, $value = null, $attribs = null,
        $options = null, $listsep = "<br />\n",$validates=array())
    {
        ...
        foreach ($options as $opt_value => $opt_label) {
        	...
        	if ($flag == true) {
        		...
        		$validate = (count($vali) > 0 )?'validate="'.implode(',', $vali).'"':'';
        		$xhtmlLabelError = '<label for="'.$name.'" class="error" style="display: none;">'
        				.$validates['message']
        				.'</label>';
        		//var_dump($a);
        	}        	
