 ...
 * @version    $Id: FormMultiCheckbox.php 24594 2012-01-05 21:27:01Z matthew $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Core_View_Helper_JQMFormMultiCheckbox extends Core_View_Helper_JQMFormRadio
{
    /**
     * Input type to use
     * @var string
     ...
     */
    public function jQMFormMultiCheckbox($name, $value = null, $attribs = null,
        $options = null, $listsep = "<br />\n",$validates=array())
    {
        return $this->jQMFormRadio($name, $value, $attribs, $options, $listsep,$validates);
    }
}
