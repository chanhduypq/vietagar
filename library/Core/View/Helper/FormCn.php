 ...
 */
class Core_View_Helper_FormCn extends Zend_View_Helper_Abstract{
	/**
	 * @author Trần Công Tuệ
	 ...
	 * @return string $html
	 */
	public function formCn($view,$form,$numberOfElement_per_row,$echo_form_tag,$type='table'){
				...
				?>
					<table width="100%"> 
						...
						foreach ($elements as $element){	
                                                    if(strpos($element->getName(), '_cn') !== FALSE){
							if($j==0){
								echo '<tr>';
							}
