 ...
 */
class Core_View_Helper_FormEn extends Zend_View_Helper_Abstract{
	/**
	 * @author Trần Công Tuệ
	 ...
	 * @return string $html
	 */
	public function formEn($view,$form,$numberOfElement_per_row,$echo_form_tag,$type='table'){
				...
				?>
					<table width="100%"> 
						...
						foreach ($elements as $element){	
                                                    if(strpos($element->getName(), '_en') !== FALSE){
							if($j==0){
								echo '<tr>';
							}
